...
//            } 
        ...
        */
        public function create_Game($id_first, $id_second)
        {
            ...
            $board_json = array("board"=>array(array("piece"=> 3,"row"=>0,"col"=> 0,"status"=>true,"id"=> 110)),
                                         array(array("piece"=> 1, "row"=> 0, "col"=> 1, "status"=> true, "id"=>120)),
                                         array(array("piece"=> 2, "row"=> 0, "col"=>2, "status"=> true, "id"=>130)),
                                         array(array("piece"=> 4, "row"=>0, "col"=>3, "status"=> true, "id"=>140)),
                                         array(array("piece"=> 5, "row"=>0, "col"=>4, "status"=> true, "id"=>150)),
                                         ...
                                         array(array( "piece"=>4,  "row"=>7, "col"=>3, "status"=> true, "id"=>240 )),
                                         array(array( "piece"=>5, "row"=>7, "col"=>4, "status"=> true, "id"=>250 )),
