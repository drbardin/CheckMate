...
<?php
    class Piece {
		...
		private $potential_moves = array("to"=>array(array()));
        //private $potential_moves = array(array());
        //private $potential_moves;
        
        function __construct($piece_row, $piece_col) {
            $this->db_host = "mysql.cs.iastate.edu";
            $this->db_user = 'u309M13';
            $this->db_pass = 'T2GWRYDIw';
            $this->db_name = 'db309M13';
            // Create connection
